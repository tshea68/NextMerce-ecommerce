        ...
        <div className="mx-auto w-full max-w-[1700px] px-3 sm:px-4">
          ...
          <div className="pb-3 lg:hidden">
            <button
              type="button"
              onClick={() => setSearchOpen(true)}
              className="flex min-h-11 w-full items-center gap-3 rounded-xl border border-black/20 bg-white px-3 py-2.5 text-left text-sm font-semibold text-black shadow-sm transition active:bg-black/[0.03]"
              aria-label="Open search"
            >
              <Search className="h-4 w-4 shrink-0 text-[#06254a]" />
              <span className="min-w-0 flex-1 leading-tight text-slate-600">
                Search by part or model number
              </span>
            </button>
          </div>
        </div>
